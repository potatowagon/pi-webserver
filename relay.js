...
const defaultConfig = {
  pan: {
    max: 550,   //maximum pulse width/extreme right position
    min: 2450,  //minimum pulse width/extreme left position
    pin: 2      //GPIO pin the servo motor is connected to
  },
  tilt: {       //not used; a feature for future implementation
    max: 1700,
    min: 1000,
    pin: 23
  }
...
class PanTilt {
  ...
  // this gives more convenient control with script.js
